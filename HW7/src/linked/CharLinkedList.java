...
public class CharLinkedList {
	...
	// returns the first node in the list whose data is equal to ch.
	...
	// use find method to find the first node in the list equal to ch
	// if not found, throw an IllegalArgumentException
	// if found, create new node containing all the same data, and inserts
	// that node into the list either immediately before or immediately after
	// the found node
